...
type BaseTooltipProps = RechartsTooltipProps<TooltipValue, TooltipName>;
type BaseTooltipContentProps =
  RechartsTooltipContentProps<TooltipValue, TooltipName>;
type TooltipPayload = RechartsTooltipPayload<TooltipValue, TooltipName>;

type ChartTooltipContentProps = Omit<
  BaseTooltipProps,
  "payload" | "active" | "label"
> &
  Partial<Pick<BaseTooltipContentProps, "payload" | "active" | "label">> &
  React.ComponentProps<"div"> & {
    hideLabel?: boolean;
            ...
            >
              ...
              item.name ? (
                formatter(
                  ...
                  index,
                  tooltipPayload as TooltipPayload[],
                )
              ) : (
                <>
                  {itemConfig?.icon ? (
